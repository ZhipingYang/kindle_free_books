...
[![Books](https://img.shields.io/badge/资源-695%20个-blue.svg)](https://zhipingyang.github.io/kindle_free_books/)
...
全库现收录 **695 个资源文件**，聚合为 **648 部独立作品**（MOBI: 610 个, EPUB: 77 个, TXT: 8 个），总数据体积约 1.03 GB：
...
| **网络小说** | **8 本** | MOBI | 《七夜雪》、《诛仙》、《佣兵天下》、《九州缥缈录》、《人间》等经典完本作品 |
